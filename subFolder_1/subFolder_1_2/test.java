...
//	static final String QUEUE = "DH_TESTING";// testing queue
	...
	public static void main(String[] args) throws Exception {
    	...
    	InputStream inputStream=P2P2.class.getResourceAsStream(PROPERTIES_FILE_PATH);
    	// load the properties
...
//        	sendMsgtoQueue(sendFrenchMsg(), TAG, queueIn);
        	sendMsgtoQueue(inwardMsg(i), TAG, queueIn);
...
//        receivedAsJMS();
	...
	private static String inwardMsg(int i ) {
		return "<?xml version=\"1.0\" encoding=\"ISO-8859-1\" standalone=\"yes\"?>\r\n"
				+ "<Document xmlns=\"pacs.008.001.09\">\r\n"
				+ "    <FIToFIPmtStsRpt>\r\n"
				+ "        <GrpHdr>\r\n"
...
//    	baos.write(textMessage.getBytes(StandardCharsets.UTF_8));
	...
	static void sendMsgtoQueue(String message, String tag, nAbstractChannel queue) throws Exception {
